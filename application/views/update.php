...
<body style="background-image: url('http://localhost/tugasakhir/public/image/update.jpeg'); background-repeat:no-repeat; background-size:cover; background-attachment: fixed; background-position: right 20% bottom 50%;">
