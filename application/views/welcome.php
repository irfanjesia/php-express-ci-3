...
<body style="background-image: url('http://localhost/tugasakhir/public/image/welcome.jpeg'); background-repeat:no-repeat; background-size:cover;">
<div class="container-fluid">
	...
	<div class="row justify-content-md-center">
		<div class="col col-lg-6" align="center">
			<p>Jasa pengiriman berbasis teknologi yang mendukung pertumbuhan e-commerce dengan jangkauan ke seluruh
				Indonesia.</p>
		</div>
	</div>
</div>
