...
<body>
	...
	<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="http://localhost/tugasakhir/public/image/carousel1.png" class="d-block w-100" style="width: 100%; height: 565px;" alt="carousel1">
			...
			<div class="carousel-item">
				<img src="http://localhost/tugasakhir/public/image/carousel2.png" class="d-block w-100" style="width: 100%; height: 565px;" alt="carousel2">
				<div class="carousel-caption d-none d-md-block">
			...
			<div class="carousel-item">
				<img src="http://localhost/tugasakhir/public/image/carousel3.png" class="d-block w-100" style="width: 100%; height: 565px;" alt="carousel3">
				<div class="carousel-caption d-none d-md-block">
					<h5>PHP Kilat</h5>
	...
	<section style="background-color: #eeeeee;" id="tentang">
		<div>
			<div class="clearfix" style="margin-right: 40px; margin-left: 40px; margin-bottom: 40px; margin-top: 40px; padding-top: 40px; padding-bottom: 30px;">
	...
	<section style="padding: 2% 5%; text-align: center" id="team">
		...
		<div class="row" style="margin-top: 40px">
			<div style="text-align: center; padding: 3%" class="feature-box col-lg-3">
				<img style="width: 70%; margin-bottom: 1rem; border-radius: 100%" src="http://localhost/tugasakhir/public/image/foto1.jpg" alt="Irfan">
				<h4>Irfan Jesia Abyakta</h4>
				<p>195150407111021</p>
			</div>

			<div style="text-align: center; padding: 3%" class="feature-box col-lg-3">
				<img style="width: 70%; margin-bottom: 1rem; border-radius: 100%" src="http://localhost/tugasakhir/public/image/foto2.jpg" alt="Zia">
				<h4>Hafia Azzahra</h4>
				<p>195150400111049</p>
			</div>

			<div style="text-align: center; padding: 3%" class="feature-box col-lg-3">
				<img style="width: 70%; margin-bottom: 1rem; border-radius: 100%" src="http://localhost/tugasakhir/public/image/foto3.jpg" alt="Nanta">
				<h4>Putu Ananta Yoga</h4>
				<p>195150401111033</p>
			</div>

			<div style="text-align: center; padding: 3%" class="feature-box col-lg-3">
				<img style="width: 70%; margin-bottom: 1rem; border-radius: 100%" src="http://localhost/tugasakhir/public/image/foto4.jpg" alt="Cornel">
