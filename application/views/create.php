...
<body style="background-image: url('http://localhost/tugasakhir/public/image/create.jpg'); background-repeat:no-repeat; background-size:cover;">
...
<div class="container-fluid">
	<div class="row">
		<div class="col" style="margin-right: 40px; margin-left: 40px; margin-bottom: 40px; margin-top: 40px;">
			<h1>Create</h1>
			<br>
			<form action='<?php echo base_url('/paket/create_process/'); ?>' method='post'
